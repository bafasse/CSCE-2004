...
//
// Authors: John Gauch, ADD YOUR NAME HERE
//------------------------------------------------------------
...
void Room1(int &gold, int &health)
{
	...
	char confirm;
	int i = 0 + rand() % ((5 - 0) + 1);
	cout << "It appears there is a treasure chest. Would you like to open it? (Y/N): ";
	cin >> confirm;
	...
	if (confirm == 'Y')
		...
		cout << "You chose not to open the treasure chest and move on.\n";
...
{
	cout << "\n------------------------------------------------------------\n";
	cout << "\nYou have entered what appears to bed a bedroom.\n";
	cout << "You see a large bed in the center of the room with a nightstand.\n";
	cout << "on either side of the bed. You feel tired and want to take a nap.\n";
